...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      background: {
        normal: `radial-gradient(circle at 50% -15%, ${colors.normal} 50%, ${colors.white} 50%)`,
        fire: `radial-gradient(circle at 50% -15%, ${colors.fire} 50%, ${colors.white} 50%)`,
        water: `radial-gradient(circle at 50% -15%, ${colors.water} 50%, ${colors.white} 50%)`,
        electric: `radial-gradient(circle at 50% -15%, ${colors.electric} 50%, ${colors.white} 50%)`,
        grass: `radial-gradient(circle at 50% -15%, ${colors.grass} 50%, ${colors.white} 50%)`,
        ice: `radial-gradient(circle at 50% -15%, ${colors.ice} 50%, ${colors.white} 50%)`,
        fighting: `radial-gradient(circle at 50% -15%, ${colors.fighting} 50%, ${colors.white} 50%)`,
        poison: `radial-gradient(circle at 50% -15%, ${colors.poison} 50%, ${colors.white} 50%)`,
        ground: `radial-gradient(circle at 50% -15%, ${colors.ground} 50%, ${colors.white} 50%)`,
        flying: `radial-gradient(circle at 50% -15%, ${colors.flying} 50%, ${colors.white} 50%)`,
        psychic: `radial-gradient(circle at 50% -15%, ${colors.psychic} 50%, ${colors.white} 50%)`,
        bug: `radial-gradient(circle at 50% -15%, ${colors.bug} 50%, ${colors.white} 50%)`,
        rock: `radial-gradient(circle at 50% -15%, ${colors.rock} 50%, ${colors.white} 50%)`,
        ghost: `radial-gradient(circle at 50% -15%, ${colors.ghost} 50%, ${colors.white} 50%)`,
        dragon: `radial-gradient(circle at 50% -15%, ${colors.dragon} 50%, ${colors.white} 50%)`,
        dark: `radial-gradient(circle at 50% -15%, ${colors.dark} 50%, ${colors.white} 50%)`,
        steel: `radial-gradient(circle at 50% -15%, ${colors.steel} 50%, ${colors.white} 50%)`,
        fairy: `radial-gradient(circle at 50% -15%, ${colors.fairy} 50%, ${colors.white} 50%)`,
      },
      backgroundImage: {
